...
export const sendInviteEmail = gated(live.sendInviteEmail)
...
export const deleteOffer = gated(live.deleteOffer)
export const offerDeletePreview = gated(live.offerDeletePreview)
...
export const staffSetDemoMode = gated(live.staffSetDemoMode)
