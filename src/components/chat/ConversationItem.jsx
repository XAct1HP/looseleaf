    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1.5">
          ...
          {/* The test thread is not labelled in this list. It has to read as
              an ordinary match while it is being demonstrated; what says
              otherwise is the banner inside the thread itself. */}
